        ...
        <div class="nav"  :style="{backgroundColor:themeColor}">
          ...
          >
              ...
              <el-submenu  index="4">
                ...
                <el-menu-item @click="changeColor(item.color)" v-for="(item,i) in theme" :key="i" :index="item.color">{{item.title}}</el-menu-item>
